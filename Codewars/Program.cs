...
MaxDifff md = new MaxDifff();
SortMyStrings sortMyStrings = new SortMyStrings();
MergeArrayz mergeArrayz = new MergeArrayz();
Websitez websitez = new Websitez();
alternateCases alternate = new alternateCases();
xoxo.XO("xo");
...
md.MaxDiff(new[] { 0, 1, 2, 3, 4, 5, 16 });
sortMyStrings.SortMyString("CodeWars");
